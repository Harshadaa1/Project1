            ...
            <div class="row">
                <div class="col-sm-6">
                  <label>Full-name</label><br>
                    ...
                    <input type="text" onkeypress="javascript:return isContact(event)" maxlength="10" minlength="10" name="txt_num" placeholder="Enter contact number"   required class="form-control w-75" /><br>
