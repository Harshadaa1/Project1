...
CREATE TABLE `flight_status` (
  `flightno` int(15) DEFAULT NULL,
  `type` varchar(50) DEFAULT NULL,
  `destn` varchar(50) DEFAULT NULL,
  `departime` double DEFAULT NULL,
  `arritime` double DEFAULT NULL,
...
-- Dump completed on 2025-04-02 13:28:33
